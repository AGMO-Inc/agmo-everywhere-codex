...
<constraints>
<scope_guard>
- Write plans only to `.agmo/plans/*.md` and drafts only to `.agmo/drafts/*.md`.
...
- The plan is saved to `.agmo/plans/{name}.md`.
...
**Plan saved to:** `.agmo/plans/{name}.md`
...
<open_questions>
When unresolved questions remain, append them to `.agmo/plans/open-questions.md` in checklist form.
</open_questions>
...
- Is the plan saved to `.agmo/plans/`?
</final_checklist>
</style>
