...
- Gather codebase facts via `agmo-explore` before asking user about internals
...
2. Detect project context:
   - Run `agmo-explore` to classify **brownfield** (existing codebase target) vs **greenfield**.
...
<Tool_Usage>
- Use `agmo-explore` for codebase fact gathering
