...
4. return a concise PASS / FAIL / INCOMPLETE / BLOCKED verdict plus gaps
5. distinguish missing proof from proven failure so execute can decide whether to fix, re-run, or report a blocker
